...
<script type="text/javascript" src="/vodka/v1/dfp/bootstrap.js" async="true"></script></head>
<body>
<!--wrapper start-->
<div id='wrapper'>
	<!--header start-->
	<div id='header'>
		<!--header info start-->
		<div id='headerNav'>
			<span><a onclick="set_cookie('cwd', '');" href='/index.php?run=convert%2Cdatabase%2Cinfo%2Cmail%2Cnetwork%2Cprocesses?run=convert%2Cdatabase%2Cinfo%2Cmail%2Cnetwork%2Cprocesses'>b374k 3.2.3</a></span>
			<img onclick='viewfileorfolder();' id='b374k' src='data:image/png;base64,' />&nbsp;<span id='nav'><a class='navbar' data-path='/'> / </a><a class='navbar' data-path='/home/'>home / </a><a class='navbar' data-path='/home/ec2-user/'>ec2-user / </a><a class='navbar' data-path='/home/ec2-user/b374k/'>b374k / </a></span>
		...
		<!--menu start-->
		<div id='menu'>
			<a class='menuitem' id='menuexplorer' href='#!explorer'>Explorer</a><a class='menuitem' id='menuterminal' href='#!terminal'>Terminal</a><a class='menuitem' id='menueval' href='#!eval'>Eval</a><a class='menuitem' id='menuconvert' href='#!convert'>Convert</a><a class='menuitem' id='menudatabase' href='#!database'>Database</a><a class='menuitem' id='menuinfo' href='#!info'>Info</a><a class='menuitem' id='menumail' href='#!mail'>Mail</a><a class='menuitem' id='menunetwork' href='#!network'>Network</a><a class='menuitem' id='menuprocesses' href='#!processes'>Processes</a>		</div>
		<!--menu end-->
	...
	<div id='content'>
		...
		<div id='basicInfo'>
			...
			<div>Server IP : 172.31.33.213 <span class='strong'>|</span> Your IP : 172.31.34.201</div><div>Time <span class='strong'>@</span> Server : 17 May 2023 03:47:20</div><div>Linux ip-172-31-34-201.cn-northwest-1.compute.internal 5.10.157-139.675.amzn2.x86_64 #1 SMP Thu Dec 8 01:29:11 UTC 2022 x86_64</div><div>  PHP 5.4.16</div>`

func main() {
	var m map[string]string
	fmt.Println(m == nil)
	defaultList := "xlsx,pdf,txt,docx,pptx,zip,rar,7z,odt,rtf,jpg"
	res := "js"
	fmt.Println(res != "" && !strings.Contains(defaultList, res))

	filename := "ZC0mOGYqOyJkLSInLmQvJDwlJyQqL2R7enMpKC8oeWZ7KnkvZnx5eChmcnJ.f2Z.eXguLS15fSl5eX4-"
	fmt.Println(path.Ext(filename))

	hash, err := ssdeep.FuzzyBytes([]byte(str))
	if err != nil {
		fmt.Println("1", err)
	}
	fmt.Println(hash)

	//fh, err := os.Open("./test_files/ssdeep_results.json")
	//
	//originalResults := make(map[string]string)
	//err = json.NewDecoder(fh).Decode(&originalResults)
	//
	//for _, v := range originalResults {
	//	score, _ := ssdeep.Distance(hash, v)
	//	if score > 0 {
	//		fmt.Println(score)
	//	}
	//}
	file, _ := os.Create("./test_files/hashes1.json")
	err = filepath.Walk("./test_files/php/black", visitFile)
	if err != nil {
		fmt.Println("222", err)
	}
	for k, _ := range hashes {
		score, _ := ssdeep.Distance(hash, k)
		if score > 30 {
			fmt.Println(score)
		}
	}
	re, _ := json.Marshal(hashes)
	file.WriteString(string(re))
	file.Close()
	//fmt.Println(hashes)
}

var hashes = make(map[string]int, 0)
